...
const TIERS: Tier[] = [
  {
    ...
    features: [
      ...
      'Public embedding & sharing',
      'Remix any project',
      'All 32 templates & npm packages',
      'React, Vue, Svelte, Solid, Preact, Python',
      'Limited by URL size (~50-100 files)',
    ],
    cta: 'Start building',
  },
  {
    ...
    verb: 'Keep',
    price: 7,
    description: 'Save your work. Ship with short links.',
    features: [
      'Everything in Free',
      'Unlimited files & project size',
      'Cloud storage with short embed URLs',
      'Private projects',
      'Version history',
      'Public profile page',
      '1 custom domain',
  ...
  },
  {
    ...
    verb: 'Ship',
    price: 12,
    description: 'Professional hosting with your own domains',
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      'Role-based access',
      'Team billing & dedicated support',
    ],
    cta: 'Upgrade to Team',
  },
]
