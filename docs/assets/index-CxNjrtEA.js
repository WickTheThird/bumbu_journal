...
<span class="drip">  │         │     ║           │</span>
<span class="drip">  │         │     ║           │</span>
<span class="drip">            ╵     ╵            </span>`,a={name:"Filip Bumbu",alias:"WickTheThird",title:"Full Stack Developer & Freelancer",location:"Ireland 🇮🇪",email:"contact@filipbumbu.dev",github:"https://github.com/WickTheThird",linkedin:"https://www.linkedin.com/in/filip-bumbu-410741262/",status:"Available for hire ✓"};let r=[];const k=[{category:"Languages",items:["JavaScript","TypeScript","Python","Java","C++"]},{category:"Frontend",items:["React","Vue","Tailwind","HTML/CSS"]},{category:"Backend",items:["Node.js","Express","Django","REST APIs"]},{category:"Database",items:["PostgreSQL","MongoDB","Redis"]},{category:"Tools",items:["Git","Docker","Linux","AWS"]}],d={help:()=>`
...
`},y=["",'<span class="ascii-logo">'+b+"</span>","",'<span class="dim">────────────────────────────────────────────────────────────</span>',"",`  <span class="green">WICK TERMINAL</span> <span class="dim">v3.0.0</span>  <span class="yellow">│</span>  <span class="white">${a.name}</span>  <span class="yellow">│</span>  <span class="dim">${a.title}</span>`,"",`  <span class="green">${a.status}</span>`,"",'<span class="dim">────────────────────────────────────────────────────────────</span>',"",'  <span class="yellow">⚡</span> Type <span class="green">help</span> to see available commands','  <span class="yellow">⚡</span> Type <span class="green">about</span> to learn more about me','  <span class="yellow">⚡</span> Type <span class="green">proj</span> to see my work',""];document.querySelector("#app").innerHTML=`
