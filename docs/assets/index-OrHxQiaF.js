...
╚███╔███╔╝ ██║ ╚██████╗ ██║  ██╗
 ╚══╝╚══╝  ╚═╝  ╚═════╝ ╚═╝  ╚═╝
`,d=["",'<span class="cyan ascii-logo">'+u+"</span>","",'<span class="dim">────────────────────────────────────────────────────────────</span>',"",'  <span class="green">WICK TERMINAL</span> <span class="dim">v3.0.0</span> <span class="yellow">64 bit</span> <span class="dim">| Educational Mode</span>',"",'  <span class="dim">Port:</span> <span class="white">6379</span>','  <span class="dim">PID:</span> <span class="white">42069</span>','  <span class="dim">Mode:</span> <span class="green">standalone</span>',"",'  <span class="dim">Documentation:</span> <span class="cyan">https://github.com/WickTheThird</span>',"",'<span class="dim">────────────────────────────────────────────────────────────</span>',"",'  <span class="yellow">⚡</span> Type <span class="green">help</span> to see available commands','  <span class="yellow">⚡</span> Type <span class="green">about</span> to learn more','  <span class="yellow">⚡</span> Type <span class="green">clear</span> to reset the terminal',""];document.querySelector("#app").innerHTML=`
